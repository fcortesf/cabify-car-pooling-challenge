...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class CarDto : IEquatable<CarDto>
    { 
        /// <summary>
        /// Gets or Sets Id
        /// </summary>
        ...
        [Range(4, 6, ErrorMessage = "The field {0} must be bewtween {1} and {2}.")]
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((CarDto)obj);
        }

        /// <summary>
        /// Returns true if CarDto instances are equal
        /// </summary>
        /// <param name="other">Instance of CarDto to be compared</param>
        /// <returns>Boolean</returns>
